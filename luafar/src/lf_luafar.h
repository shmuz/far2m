...
DLLFUNC int    LF_DeleteFiles (lua_State* L, HANDLE hPanel,struct PluginPanelItem *PanelItem,int ItemsNumber,int OpMode);
...
DLLFUNC int    LF_GetFiles (lua_State* L, HANDLE hPanel,struct PluginPanelItem *PanelItem,int ItemsNumber,int Move,const wchar_t **DestPath,int OpMode);
DLLFUNC int    LF_GetFindData (lua_State* L, HANDLE hPanel,struct PluginPanelItem **pPanelItem,int *pItemsNumber,int OpMode);
...
DLLFUNC int    LF_MakeDirectory (lua_State* L, HANDLE hPanel,const wchar_t **Name,int OpMode);
...
DLLFUNC int    LF_ProcessHostFile (lua_State* L, HANDLE hPanel,struct PluginPanelItem *PanelItem,int ItemsNumber,int OpMode);
...
DLLFUNC int    LF_PutFiles (lua_State* L, HANDLE hPanel,struct PluginPanelItem *PanelItem,int ItemsNumber,int Move,const wchar_t *SrcPath,int OpMode);
DLLFUNC int    LF_SetDirectory (lua_State* L, HANDLE hPanel,const wchar_t *Dir,int OpMode);
...
DLLFUNC int    LF_GetLinkTarget(lua_State *L, HANDLE hPanel, struct PluginPanelItem *PanelItem, wchar_t *Target, size_t TargetSize, int OpMode);
