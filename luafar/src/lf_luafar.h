...
DLLFUNC int    LF_DeleteFiles (lua_State* L, HANDLE hPanel,struct PluginPanelItem *PanelItem,int ItemsNumber,OPERATION_MODES OpMode);
DLLFUNC void   LF_ExitFAR (lua_State* L);
DLLFUNC void   LF_FreeFindData (lua_State* L, HANDLE hPanel,struct PluginPanelItem *PanelItem,int ItemsNumber);
DLLFUNC int    LF_GetFiles (lua_State* L, HANDLE hPanel,struct PluginPanelItem *PanelItem,int ItemsNumber,int Move,const wchar_t **DestPath,OPERATION_MODES OpMode);
DLLFUNC int    LF_GetFindData (lua_State* L, HANDLE hPanel,struct PluginPanelItem **pPanelItem,int *pItemsNumber,OPERATION_MODES OpMode);
DLLFUNC void   LF_GetOpenPanelInfo (lua_State* L, HANDLE hPanel,struct OpenPluginInfo *Info);
DLLFUNC void   LF_GetPluginInfo (lua_State* L, struct PluginInfo *Info);
DLLFUNC int    LF_MakeDirectory (lua_State* L, HANDLE hPanel,const wchar_t **Name,OPERATION_MODES OpMode);
...
DLLFUNC int    LF_ProcessPanelEvent (lua_State* L, HANDLE hPanel,int Event,void *Param);
DLLFUNC int    LF_ProcessHostFile (lua_State* L, HANDLE hPanel,struct PluginPanelItem *PanelItem,int ItemsNumber,OPERATION_MODES OpMode);
DLLFUNC int    LF_ProcessKey (lua_State* L, HANDLE hPanel,int Key,unsigned int ControlState);
...
DLLFUNC int    LF_PutFiles (lua_State* L, HANDLE hPanel,struct PluginPanelItem *PanelItem,int ItemsNumber,int Move,const wchar_t *SrcPath,OPERATION_MODES OpMode);
DLLFUNC int    LF_SetDirectory (lua_State* L, HANDLE hPanel,const wchar_t *Dir,OPERATION_MODES OpMode);
DLLFUNC int    LF_SetFindList (lua_State* L, HANDLE hPanel,const struct PluginPanelItem *PanelItem,int ItemsNumber);
...
DLLFUNC int    LF_GetLinkTarget(lua_State *L, HANDLE hPanel, struct PluginPanelItem *PanelItem, wchar_t *Target, size_t TargetSize, OPERATION_MODES OpMode);
