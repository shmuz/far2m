...
local function TestArea (area, k_before, k_after)
  ...
  local A = asrt.num(far.MacroGetArea())
  asrt.eq(A, F[area])
  if k_after then Keys(k_after) end
end

local function test_far_MacroGetArea()
  TestArea ("MACROAREA_SHELL")
  TestArea ("MACROAREA_GRABBER",    "AltIns",     "Esc")
  TestArea ("MACROAREA_SHELL",      "F12 0")
  TestArea ("MACROAREA_EDITOR",     "ShiftF4 CtrlY Enter", "Esc")
  TestArea ("MACROAREA_DIALOG",     "F7",         "Esc")
  TestArea ("MACROAREA_SEARCH",     "Alt?",       "Esc")
  TestArea ("MACROAREA_DISKS",      "AltF1",      "Esc")
  TestArea ("MACROAREA_DISKS",      "AltF2",      "Esc")
  TestArea ("MACROAREA_MAINMENU",   "F9",         "Esc")
  TestArea ("MACROAREA_MAINMENU",   "F9 Enter",   "Esc Esc")
  TestArea ("MACROAREA_MENU",       "F12",        "Esc")
  TestArea ("MACROAREA_HELP",       "F1",         "Esc")
  TestArea ("MACROAREA_INFOPANEL",  "CtrlL Tab",  "Tab CtrlL")
  TestArea ("MACROAREA_QVIEWPANEL", "CtrlQ Tab",  "Tab CtrlQ")
  TestArea ("MACROAREA_TREEPANEL",  "CtrlT Tab",  "Tab CtrlT")
  TestArea ("MACROAREA_FINDFOLDER", "AltF10",     "Esc")
  TestArea ("MACROAREA_USERMENU",   "F2",         "Esc")
  TestArea ("MACROAREA_SHELL")
end
