...
typedef int (__stdcall *FARAPIMESSAGE)(
...
typedef int (__stdcall *FARAPIMESSAGEV3)(
	INT_PTR PluginNumber,
	const GUID* Id,
	DWORD Flags,
	const wchar_t *HelpTopic,
...
typedef HANDLE(__stdcall *FARAPIDIALOGINITV3)(
	INT_PTR               PluginNumber,
	const GUID           *Id,
	int                   X1,
	int                   Y1,
...
typedef intptr_t (__stdcall *FARMACROCALLBACK)(void* Id,DWORD Flags);
...
enum VIEWER_OPTIONS
{
	VOPT_SAVEFILEPOSITION   = 0x0001,
	VOPT_AUTODETECTCODEPAGE = 0x0002,
	VOPT_SHOWTITLEBAR       = 0x0004,
	VOPT_SHOWKEYBAR         = 0x0008,
	VOPT_SHOWSCROLLBAR      = 0x0010,
	VOPT_QUICKVIEW          = 0x0020,
	VOPT_NONE               = 0,
};
...
typedef int (__stdcall *FARAPIVIEWERCONTROLV2)(
	int ViewerID,
	int Command,
	void *Param
);
...
enum EDITOR_CONTROL_COMMANDS
{
	...
	ECTL_GETTITLE,
	ECTL_INSERTTEXT_V2,
	ECTL_SETVIRTUALFILENAME,
	ECTL_SETSAVEDSTATE,
	ECTL_GETVIRTUALFILENAME,
};
...
typedef int (__stdcall *FARAPIEDITORCONTROLV2)(
	int EditorID,
	int Command,
	void *Param
);
...
typedef intptr_t (__stdcall *FARAPIPLUGINSCONTROLV3)(
	HANDLE hHandle,
	int Command,
	intptr_t Param1,
	void* Param2
...
typedef int (__stdcall *FARSTDGETFILEGROUP)(const wchar_t *Computer,const wchar_t *Name,wchar_t *Group,int Size);
...
typedef wchar_t   *(__stdcall *FARSTDTRUNCSTR)(wchar_t *Str,int MaxCells);
typedef wchar_t   *(__stdcall *FARSTDTRUNCPATHSTR)(wchar_t *Str,int MaxCells);
...
typedef FarKey (__stdcall *FARSTDINPUTRECORDTOKEY)(const INPUT_RECORD *r);
...
enum PROCESSNAME_FLAGS
{
	...
	PN_CHECKMASK        = 0x00030000U,
	PN_SKIPPATH         = 0x01000000U,
	PN_SHOWERRORMESSAGE = 0x02000000U,
	PN_RESERVED1        = 0x04000000U,
	PN_CASESENSITIVE    = 0x08000000U,
	PN_NONE             = 0
};
...
typedef size_t (__stdcall *FARSTDKEYTOKEYNAME)(FarKey Key,wchar_t *KeyText,size_t Size);

typedef wchar_t*(__stdcall *FARSTDXLAT)(wchar_t *Line,int StartPos,int EndPos,DWORD Flags);

typedef FarKey (__stdcall *FARSTDKEYNAMETOKEY)(const wchar_t *Name);
...
typedef size_t (__stdcall *FARFORMATFILESIZE)(uint64_t Size, int Width, DWORD Flags, wchar_t *Dest, size_t DestSize);
...
typedef int (__stdcall *FARGETFILEOWNER)(const wchar_t *Computer, const wchar_t *Name, wchar_t *Owner, int Size);
typedef int (__stdcall *FARESETFILEMODE)(const wchar_t *Name, DWORD Mode, int SkipMode);
typedef int (__stdcall *FARESETFILETIME)(const wchar_t *Name, FILETIME *AccessTime, FILETIME *ModifyTime, DWORD FileAttr, int SkipMode);
typedef int (__stdcall *FARESETFILEGROUP)(const wchar_t *Name, const wchar_t *Group, int SkipMode);
typedef int (__stdcall *FARESETFILEOWNER)(const wchar_t *Name, const wchar_t *Owner, int SkipMode);
typedef const char *(__stdcall *FAROWNERNAMEBYID)(uid_t id);
typedef const char *(__stdcall *FARGROUPNAMEBYID)(uid_t id);
typedef size_t (__stdcall *FARREADLINK)(const char *path, char *buf, size_t bufsiz);
typedef BOOL (__stdcall *FARSDCLSTAT)(const wchar_t *path, void *s);
typedef int (__stdcall *FARSDCSYMLINK)(const char *path1, const char *path2);
typedef BOOL (__stdcall *FARGETFINDDATA)(const wchar_t *lpwszFileName, WIN32_FIND_DATAW *FindDataW);

typedef int (__stdcall *FARGETDATEFORMAT)(void);
typedef wchar_t (__stdcall *FARGETDATESEPARATOR)(void);
typedef wchar_t (__stdcall *FARGETTIMESEPARATOR)(void);
typedef wchar_t (__stdcall *FARGETDECIMALSEPARATOR)(void);
...
struct ProcessEditorEventInfo
{
	...
	int    __stdcall  GetLinkTargetW(HANDLE hPlugin,struct PluginPanelItem *PanelItem,wchar_t *Target,size_t TargetSize,int OpMode);
