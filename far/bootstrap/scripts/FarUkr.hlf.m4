...
$ #Регулярні вирази для заміни#
    В рядку "Замінити на" можна використовувати наступні спеціальні вирази заміни:

    #$N# або #${N}# (де N — одна або більше десяткових цифр)
    Вони представляють номери захоплених груп і замінюються відповідним знайденим текстом.
...
їх необхідно екранувати зворотною косою рискою (тобто #\$# та #\\\\#).
    ...
    Як #\n#, так і #\r# інтерпретуються як розриви рядків, автоматично адаптуючись
до стилю кінця рядка, що використовується у файлі. Вони працюють однаково.

    #\t# замінюється символом табуляції (0x09).

    #\xNN# (де N — шістнадцяткова цифра)
    Це вираз буде замінено байтом із вказаним значенням.
