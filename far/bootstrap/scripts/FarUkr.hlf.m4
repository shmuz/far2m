...
Це особливість поточної версії FAR2M.
  ...
  #-set:<parameter>=<value>#
  Перевизначити параметр конфігурації, подробиці дивіться ~lm:farconfig~@FarConfig@.
...
- набір додаткових ~параметрів~@KeyMacroSetting@, які впливають на спосіб
 та місце відтворення FAR2M записаної послідовності;
...
сервісні функції, умовне та циклічне відтворення послідовностей тощо.
 ...
 використовує FAR2M для здійснення тих чи інших дій.

 Основним застосуванням макросів є визначення кнопок для швидкого
виклику зовнішніх плагінів та перевизначення дій FAR2M.
