...
расширений и разрешает к использованию лишь базовые возможности обычного терминала в TTY режиме.
  ...
  #--mortal#
  Этот аргумент применим только для far2m, который работает в режиме TTY. По умолчанию пр закрытии
...
"~Путь к персональным плагинам~@PluginsManagerSettings@"
  ...
  #-m#
  При старте FAR2M не будет загружать макрокоманды из реестра.

  #-ma#
  При старте FAR2M не будет выполнять макрокоманды с опцией "Выполнять после запуска FAR2M".
