...
local function test_Far_GetConfig()
  local t = {
    "Colors.CurrentPalette",                     "binary",
    "Screen.Clock",                              "integer",
    "Screen.ViewerEditorClock",                  "integer",
    "Screen.KeyBar",                             "integer",
    "Screen.ScreenSaver",                        "integer",
    "Screen.ScreenSaverTime",                    "integer",
    "Screen.DeltaXY",                            "integer",
    "Cmdline.UsePromptFormat",                   "integer",
    "Cmdline.PromptFormat",                      "string",
    "Cmdline.UseShell",                          "integer",
    "Cmdline.Shell",                             "string",
    "Cmdline.DelRemovesBlocks",                  "integer",
    "Cmdline.EditBlock",                         "integer",
    "Cmdline.AutoComplete",                      "integer",
    "Cmdline.Splitter",                          "integer",
    "Cmdline.WaitKeypress",                      "integer",
    "Cmdline.VTLogLimit",                        "integer",
    "Interface.Mouse",                           "integer",
    "Interface.UseVk_oem_x",                     "integer",
    "Interface.ShowMenuBar",                     "integer",
    "Interface.CursorSize1",                     "integer",
    "Interface.CursorSize2",                     "integer",
    "Interface.CursorSize3",                     "integer",
    "Interface.CursorSize4",                     "integer",
    "Interface.ShiftsKeyRules",                  "integer",
    "Interface.CtrlPgUp",                        "integer",
    "Interface.ConsolePaintSharp",               "integer",
    "Interface.ExclusiveCtrlLeft",               "integer",
    "Interface.ExclusiveCtrlRight",              "integer",
    "Interface.ExclusiveAltLeft",                "integer",
    "Interface.ExclusiveAltRight",               "integer",
    "Interface.ExclusiveWinLeft",                "integer",
    "Interface.ExclusiveWinRight",               "integer",
    "Interface.OSC52ClipSet",                    "integer",
    "Interface.TTYPaletteOverride",              "integer",
    "Interface.ShowTimeoutDelFiles",             "integer",
    "Interface.ShowTimeoutDACLFiles",            "integer",
    "Interface.FormatNumberSeparators",          "integer",
    "Interface.CopyShowTotal",                   "integer",
    "Interface.DelShowTotal",                    "integer",
    "Interface.WindowTitle",                     "string",
    "Interface/Completion.Exceptions",           "string",
    "Interface/Completion.ShowList",             "integer",
    "Interface/Completion.ModalList",            "integer",
    "Interface/Completion.Append",               "integer",
    "Viewer.ExternalViewerName",                 "string",
    "Viewer.UseExternalViewer",                  "integer",
    "Viewer.SaveViewerPos",                      "integer",
    "Viewer.SaveViewerShortPos",                 "integer",
    "Viewer.AutoDetectCodePage",                 "integer",
    "Viewer.SearchRegexp",                       "integer",
    "Viewer.TabSize",                            "integer",
    "Viewer.ShowKeyBar",                         "integer",
    "Viewer.ShowTitleBar",                       "integer",
    "Viewer.ShowArrows",                         "integer",
    "Viewer.ShowScrollbar",                      "integer",
    "Viewer.IsWrap",                             "integer",
    "Viewer.Wrap",                               "integer",
    "Viewer.PersistentBlocks",                   "integer",
    "Viewer.DefaultCodePage",                    "integer",
    "Dialog.EditHistory",                        "integer",
    "Dialog.EditBlock",                          "integer",
    "Dialog.AutoComplete",                       "integer",
    "Dialog.EULBsClear",                         "integer",
    "Dialog.SelectFromHistory",                  "integer",
    "Dialog.EditLine",                           "integer",
    "Dialog.MouseButton",                        "integer",
    "Dialog.DelRemovesBlocks",                   "integer",
    "Dialog.CBoxMaxHeight",                      "integer",
    "Editor.ExternalEditorName",                 "string",
    "Editor.UseExternalEditor",                  "integer",
    "Editor.ExpandTabs",                         "integer",
    "Editor.TabSize",                            "integer",
    "Editor.PersistentBlocks",                   "integer",
    "Editor.DelRemovesBlocks",                   "integer",
    "Editor.AutoIndent",                         "integer",
    "Editor.SaveEditorPos",                      "integer",
    "Editor.SaveEditorShortPos",                 "integer",
    "Editor.AutoDetectCodePage",                 "integer",
    "Editor.EditorCursorBeyondEOL",              "integer",
    "Editor.ReadOnlyLock",                       "integer",
    "Editor.EditorUndoSize",                     "integer",
    "Editor.WordDiv",                            "string",
    "Editor.BSLikeDel",                          "integer",
    "Editor.EditorF7Rules",                      "integer",
    "Editor.FileSizeLimit",                      "integer",
    "Editor.FileSizeLimitHi",                    "integer",
    "Editor.CharCodeBase",                       "integer",
    "Editor.AllowEmptySpaceAfterEof",            "integer",
    "Editor.DefaultCodePage",                    "integer",
    "Editor.ShowKeyBar",                         "integer",
    "Editor.ShowTitleBar",                       "integer",
    "Editor.ShowScrollBar",                      "integer",
    "Editor.EditOpenedForWrite",                 "integer",
    "Editor.SearchSelFound",                     "integer",
    "Editor.SearchRegexp",                       "integer",
    "Editor.SearchPickUpWord",                   "integer",
    "Editor.ShowWhiteSpace",                     "integer",
    "Notifications.OnFileOperation",             "integer",
    "Notifications.OnConsole",                   "integer",
    "Notifications.OnlyIfBackground",            "integer",
    "XLat.Flags",                                "integer",
    "XLat.EnableForFastFileFind",                "integer",
    "XLat.EnableForDialogs",                     "integer",
    "XLat.WordDivForXlat",                       "string",
    "XLat.XLat",                                 "string",
    "SavedHistory.HistoryCount",                 "integer",
    "SavedFolderHistory.HistoryCount",           "integer",
    "SavedViewHistory.HistoryCount",             "integer",
    "SavedDialogHistory.HistoryCount",           "integer",
    "System.SaveHistory",                        "integer",
    "System.SaveFoldersHistory",                 "integer",
    "System.SavePluginFoldersHistory",           "integer",
    "System.SaveViewHistory",                    "integer",
    "System.AutoSaveSetup",                      "integer",
    "System.DeleteToRecycleBin",                 "integer",
    "System.DeleteToRecycleBinKillLink",         "integer",
    "System.WipeSymbol",                         "integer",
    "System.SudoEnabled",                        "integer",
    "System.SudoConfirmModify",                  "integer",
    "System.SudoPasswordExpiration",             "integer",
    "System.UseCOW",                             "integer",
    "System.SparseFiles",                        "integer",
    "System.HowCopySymlink",                     "integer",
    "System.WriteThrough",                       "integer",
    "System.CopyXAttr",                          "integer",
    "System.CopyAccessMode",                     "integer",
    "System.MultiCopy",                          "integer",
    "System.CopyTimeRule",                       "integer",
    "System.InactivityExit",                     "integer",
    "System.InactivityExitTime",                 "integer",
    "System.DriveMenuMode2",                     "integer",
    "System.DriveDisconnetMode",                 "integer",
    "System.DriveExceptions",                    "string",
    "System.DriveColumn2",                       "string",
    "System.DriveColumn3",                       "string",
    "System.AutoUpdateRemoteDrive",              "integer",
    "System.FileSearchMode",                     "integer",
    "System.CollectFiles",                       "integer",
    "System.SearchInFirstSize",                  "string",
    "System.FindAlternateStreams",               "integer",
    "System.SearchOutFormat",                    "string",
    "System.SearchOutFormatWidth",               "string",
    "System.FindFolders",                        "integer",
    "System.FindSymLinks",                       "integer",
    "System.UseFilterInSearch",                  "integer",
    "System.FindCodePage",                       "integer",
    "System.CmdHistoryRule",                     "integer",
    "System.SetAttrFolderRules",                 "integer",
    "System.MaxPositionCache",                   "integer",
    "System.ConsoleDetachKey",                   "string",
    "System.SilentLoadPlugin",                   "integer",
    "System.ScanSymlinks",                       "integer",
    "System.MultiMakeDir",                       "integer",
    ...
    "System.ShowCheckingFile",                   "integer",
    ...
    "System.ScanJunction",                       "integer",
    "System.OnlyFilesSize",                      "integer",
    "System.UsePrintManager",                    "integer",
    "System.WindowMode",                         "integer",
    "System/Nowell.MoveRO",                      "integer",
    "System/Executor.RestoreCP",                 "integer",
    "System/Executor.UseAppPath",                "integer",
    "System/Executor.ShowErrorMessage",          "integer",
    "System/Executor.FullTitle",                 "integer",
    "System/Executor.SilentExternal",            "integer",
    "Panel/Tree.MinTreeCount",                   "integer",
    "Panel/Tree.TreeFileAttr",                   "integer",
    "Panel/Tree.LocalDisk",                      "integer",
    "Panel/Tree.NetDisk",                        "integer",
    "Panel/Tree.RemovableDisk",                  "integer",
    "Panel/Tree.NetPath",                        "integer",
    "Panel/Tree.AutoChangeFolder",               "integer",
    "Help.ActivateURL",                          "integer",
    "Language.Help",                             "string",
    "Language.Main",                             "string",
    "Confirmations.Copy",                        "integer",
    "Confirmations.Move",                        "integer",
    "Confirmations.RO",                          "integer",
    "Confirmations.Drag",                        "integer",
    "Confirmations.Delete",                      "integer",
    "Confirmations.DeleteFolder",                "integer",
    "Confirmations.Esc",                         "integer",
    "Confirmations.RemoveConnection",            "integer",
    "Confirmations.RemoveHotPlug",               "integer",
    "Confirmations.AllowReedit",                 "integer",
    "Confirmations.HistoryClear",                "integer",
    "Confirmations.Exit",                        "integer",
    "Confirmations.EscTwiceToInterrupt",         "integer",
    "PluginConfirmations.OpenFilePlugin",        "integer",
    "PluginConfirmations.StandardAssociation",   "integer",
    "PluginConfirmations.EvenIfOnlyOnePlugin",   "integer",
    "PluginConfirmations.SetFindList",           "integer",
    "PluginConfirmations.Prefix",                "integer",
    "Panel.ShellRightLeftArrowsRule",            "integer",
    "Panel.ShowHidden",                          "integer",
    "Panel.Highlight",                           "integer",
    "Panel.SortFolderExt",                       "integer",
    "Panel.SelectFolders",                       "integer",
    "Panel.ReverseSort",                         "integer",
    "Panel.RightClickRule",                      "integer",
    "Panel.CtrlFRule",                           "integer",
    "Panel.CtrlAltShiftRule",                    "integer",
    "Panel.RememberLogicalDrives",               "integer",
    "Panel.AutoUpdateLimit",                     "integer",
    "Panel/Left.Type",                           "integer",
    "Panel/Left.Visible",                        "integer",
    "Panel/Left.Focus",                          "integer",
    "Panel/Left.ViewMode",                       "integer",
    "Panel/Left.SortMode",                       "integer",
    "Panel/Left.SortOrder",                      "integer",
    "Panel/Left.SortGroups",                     "integer",
    "Panel/Left.NumericSort",                    "integer",
    "Panel/Left.CaseSensitiveSortNix",           "integer",
    "Panel/Left.Folder",                         "string",
    "Panel/Left.CurFile",                        "string",
    "Panel/Left.SelectedFirst",                  "integer",
    "Panel/Left.DirectoriesFirst",               "integer",
    "Panel/Right.Type",                          "integer",
    "Panel/Right.Visible",                       "integer",
    "Panel/Right.Focus",                         "integer",
    "Panel/Right.ViewMode",                      "integer",
    "Panel/Right.SortMode",                      "integer",
    "Panel/Right.SortOrder",                     "integer",
    "Panel/Right.SortGroups",                    "integer",
    "Panel/Right.NumericSort",                   "integer",
    "Panel/Right.CaseSensitiveSortNix",          "integer",
    "Panel/Right.Folder",                        "string",
    "Panel/Right.CurFile",                       "string",
    "Panel/Right.SelectedFirst",                 "integer",
    "Panel/Right.DirectoriesFirst",              "integer",
    "Panel/Layout.ColumnTitles",                 "integer",
    "Panel/Layout.StatusLine",                   "integer",
    "Panel/Layout.TotalInfo",                    "integer",
    "Panel/Layout.FreeInfo",                     "integer",
    "Panel/Layout.Scrollbar",                    "integer",
    "Panel/Layout.ScrollbarMenu",                "integer",
    "Panel/Layout.ScreensNumber",                "integer",
    "Panel/Layout.SortMode",                     "integer",
    "Layout.LeftHeightDecrement",                "integer",
    "Layout.RightHeightDecrement",               "integer",
    "Layout.WidthDecrement",                     "integer",
    "Layout.FullscreenHelp",                     "integer",
    "Descriptions.ListNames",                    "string",
    "Descriptions.UpdateMode",                   "integer",
    "Descriptions.ROUpdate",                     "integer",
    "Descriptions.SetHidden",                    "integer",
    "Descriptions.StartPos",                     "integer",
    "Descriptions.AnsiByDefault",                "integer",
    "Descriptions.SaveInUTF",                    "integer",
    "KeyMacros.DateFormat",                      "string",
    "KeyMacros.CONVFMT",                         "string",
  ...
  for k=1,#t,2 do
    ...
    assert(tp == t[k+1])
    if     tp=="string"  then assert_str(val)
    elseif tp=="integer" then assert_num(val)
    elseif tp=="binary"  then assert_table(val)
    else assert(false)
    end
  end
end
