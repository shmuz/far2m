...
local function test_Guids()
  ...
  test_one_guid( "FileAssocMenuId",          mf.associations)
  test_one_guid( "FileAssocModifyId",        mf.associations, "Ins", 2)
  ...
  test_one_guid( "FolderShortcutsDlgId",     mf.fshortcuts, "F4", 2)
  test_one_guid( "FolderShortcutsId",        mf.fshortcuts)
  test_one_guid( "HardSymLinkId",            nil, "End AltF6")
  test_one_guid( "HelpSearchId",             nil, "F1 F7", 2)
  test_one_guid( "HighlightConfigId",        mf.fhighlight, "Ins", 2)
  test_one_guid( "HighlightMenuId",          mf.fhighlight)
  ...
  test_one_guid( "PanelViewModesEditId",     mf.fpanelmodes, "Enter", 2)
  test_one_guid( "PanelViewModesId",         mf.fpanelmodes)
