...
local function test_Guids()
  ...
  test_one_guid( "FileAssocMenuId",          mf.fileassociations)
  test_one_guid( "FileAssocModifyId",        mf.fileassociations, "Ins", 2)
  ...
  test_one_guid( "FolderShortcutsDlgId",     mf.foldershortcuts, "F4", 2)
  test_one_guid( "FolderShortcutsId",        mf.foldershortcuts)
  test_one_guid( "HardSymLinkId",            nil, "End AltF6")
  test_one_guid( "HelpSearchId",             nil, "F1 F7", 2)
  test_one_guid( "HighlightConfigId",        mf.filehighlight, "Ins", 2)
  test_one_guid( "HighlightMenuId",          mf.filehighlight)
  ...
  test_one_guid( "PanelViewModesEditId",     mf.filepanelmodes, "Enter", 2)
  test_one_guid( "PanelViewModesId",         mf.filepanelmodes)
