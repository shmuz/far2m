...
local function test_one_guid(val, keys, numEsc)
  numEsc = numEsc or 1
  val = far.Guids[val]
  assert_str(val)
  assert_eq(#val, 36)
...
local function test_Guids()
  ...
  test_one_guid( "ApplyCommandId", "CtrlG")
  test_one_guid( "AskInsertMenuOrCommandId", "F2 Ins", 2)
  test_one_guid( "ChangeDiskMenuId", "AltF1")
  test_one_guid( "ChangeDiskMenuId", "AltF2")
  test_one_guid( "CodePagesMenuId", "F9 Home 3*Right Enter End 4*Up Enter")
  test_one_guid( "CopyCurrentOnlyFileId", "End ShiftF5")
  test_one_guid( "CopyFilesId", "End F5")
  test_one_guid( "DeleteFileFolderId", "End F8")
  test_one_guid( "DeleteWipeId", "End AltDel")
  test_one_guid( "DescribeFileId", "End CtrlZ")
  test_one_guid( "EditUserMenuId", "F2 Ins Enter", 2)
  test_one_guid( "EditorReplaceId", "End F4 CtrlF7", 2)
  test_one_guid( "EditorSearchId", "End F4 F7", 2)
  test_one_guid( "FarAskQuitId", "F10")
  test_one_guid( "FileAssocMenuId", "F9 Home 2*Right Enter End 5*Up Enter")
  test_one_guid( "FileAssocModifyId", "F9 Home 2*Right Enter End 5*Up Enter Ins", 2)
  test_one_guid( "FileAttrDlgId", "End CtrlA")
  test_one_guid( "FileOpenCreateId", "ShiftF4")
  test_one_guid( "FileSaveAsId", "End F4 ShiftF2", 2)
  test_one_guid( "FiltersConfigId", "CtrlI Ins", 2)
  test_one_guid( "FiltersMenuId", "CtrlI")
  test_one_guid( "FindFileId", "AltF7")
  test_one_guid( "FolderShortcutsDlgId", "F9 Home 2*Right Enter End 4*Up Enter F4", 2)
  test_one_guid( "FolderShortcutsId", "F9 Home 2*Right Enter End 4*Up Enter")
  test_one_guid( "HardSymLinkId", "End AltF6")
  test_one_guid( "HelpSearchId", "F1 F7", 2)
  test_one_guid( "HighlightConfigId", "F9 Home 3*Right Enter End 2*Up Enter Ins", 2)
  test_one_guid( "HighlightMenuId", "F9 Home 3*Right Enter End 2*Up Enter")
  test_one_guid( "HistoryCmdId", "AltF8")
  test_one_guid( "HistoryEditViewId", "AltF11")
  test_one_guid( "HistoryFolderId", "AltF12")
  test_one_guid( "MakeFolderId", "F7")
  test_one_guid( "MoveCurrentOnlyFileId", "End ShiftF6")
  test_one_guid( "MoveFilesId", "End F6")
  test_one_guid( "PanelViewModesEditId", "F9 Home 3*Right Enter 12*Down Enter Enter", 2)
  test_one_guid( "PanelViewModesId", "F9 Home 3*Right Enter 12*Down Enter")
  test_one_guid( "PluginInformationId", "F11 F3", 2)
  test_one_guid( "PluginsConfigMenuId", "AltShiftF9")
  test_one_guid( "PluginsMenuId", "F11")
  test_one_guid( "ScreensSwitchId", "F12")
  test_one_guid( "SelectDialogId", "Add")
  test_one_guid( "SelectSortModeId", "CtrlF12")
  test_one_guid( "UnSelectDialogId", "Subtract")
  test_one_guid( "ViewerSearchId", "End F3 F7", 2)

  -- test_one_guid( "BadEditorCodePageId", "")
  -- test_one_guid( "CannotRecycleFileId", "")
  -- test_one_guid( "CannotRecycleFolderId", "")
  -- test_one_guid( "ChangeDriveCannotReadDiskErrorId", "")
  -- test_one_guid( "ChangeDriveModeId", "")
  -- test_one_guid( "CopyOverwriteId", "")
  -- test_one_guid( "CopyReadOnlyId", "")
  -- test_one_guid( "DeleteAskDeleteROId", "")
  -- test_one_guid( "DeleteAskWipeROId", "")
  -- test_one_guid( "DeleteFolderId", "")
  -- test_one_guid( "DeleteFolderRecycleId", "")
  -- test_one_guid( "DeleteLinkId", "")
  -- test_one_guid( "DeleteRecycleId", "")
  -- test_one_guid( "DisconnectDriveId", "")
  -- test_one_guid( "EditAskSaveExtId", "")
  -- test_one_guid( "EditAskSaveId", "")
  -- test_one_guid( "EditorAskOverwriteId", "")
  -- test_one_guid( "EditorCanNotEditDirectoryId", "")
  -- test_one_guid( "EditorConfirmReplaceId", "")
  -- test_one_guid( "EditorFileGetSizeErrorId", "")
  -- test_one_guid( "EditorFileLongId", "")
  -- test_one_guid( "EditorFindAllListId", "")
  -- test_one_guid( "EditorOpenRSHId", "")
  -- test_one_guid( "EditorReloadId", "")
  -- test_one_guid( "EditorReloadModalId", "")
  -- test_one_guid( "EditorSavedROId", "")
  -- test_one_guid( "EditorSaveExitDeletedId", "")
  -- test_one_guid( "EditorSaveF6DeletedId", "")
  -- test_one_guid( "EditorSwitchUnicodeCPDisabledId", "")
  -- test_one_guid( "EjectHotPlugMediaErrorId", "")
  -- test_one_guid( "FindFileResultId", "")
  -- test_one_guid( "FolderShortcutsMoreId", "")
  -- test_one_guid( "GetNameAndPasswordId", "")
  -- test_one_guid( "RecycleFolderConfirmDeleteLinkId", "")
  -- test_one_guid( "RemoteDisconnectDriveError1Id", "")
  -- test_one_guid( "RemoteDisconnectDriveError2Id", "")
  -- test_one_guid( "SelectAssocMenuId", "")
  -- test_one_guid( "SelectFromEditHistoryId", "")
  -- test_one_guid( "SUBSTDisconnectDriveError1Id", "")
  -- test_one_guid( "SUBSTDisconnectDriveError2Id", "")
  -- test_one_guid( "SUBSTDisconnectDriveId", "")
  -- test_one_guid( "UserMenuUserInputId", "")
  -- test_one_guid( "VHDDisconnectDriveErrorId", "")
  -- test_one_guid( "VHDDisconnectDriveId", "")
  -- test_one_guid( "WipeFolderId", "")
  -- test_one_guid( "WipeHardLinkId", "")
end
